...
async def start_command(client: Client, message: Message):
    join_button = InlineKeyboardButton("ᴊᴏɪɴ ❤️🚀", url="https://t.me/Team_Sonu1")
    developer_button = InlineKeyboardButton("contact ⚡️", url="https://t.me/Contact_AdminSbot")
    Group_button = InlineKeyboardButton("Group 🌐", url="https://t.me/BotChatAll")
    user_mention = message.from_user.mention
    reply_markup = InlineKeyboardMarkup([[join_button, developer_button], [Group_button]])
...
async def handle_message(client: Client, message: Message):
    ...
    if not is_member:
        join_button = InlineKeyboardButton("ᴊᴏɪɴ ❤️🚀", url="https://t.me/Team_Sonu1")
        join_button2= InlinekeyboardButton("Join ✨" , url="https://t.me/Team_Sonu2")
        reply_markup = InlineKeyboardMarkup([[join_button],join_button2])
    ...
    caption = (
        ...
        "[ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴊᴇᴛ-ᴍɪʀʀᴏʀ ❤️🚀](https://t.me/Yeam_Sonu1)"
    )
